...
define(function (require, exports, module) {
    ...
    function IonicPluginsDialog(ionicManager) {
        ...
        this.$inputAdd = this.$dialog.find('#ionic-plugins-add');
        this.$inputRemove = this.$dialog.find('#ionic-plugins-remove');
        this.$submitAdd = this.$dialog.find('#ionic-plugins-add-submit');
        this.$submitRemove = this.$dialog.find('#ionic-plugins-remove-submit');
        this.$tablePlugins = this.$dialog.find('table tbody');
    }
        
    /** Show dialog */
    IonicPluginsDialog.prototype.show = function () {
        ...
        this.$submitAdd.on('click', function (e) {
            ...
            var promise = self.ionicManager.runCommand(cmd);
    ...
    /** Hide dialog */
    IonicPluginsDialog.prototype.close = function () {
        Dialogs.cancelModalDialogIfOpen('dialog-ionic-plugins');
    };
    
    /** Load Plugins List */
    IonicPluginsDialog.prototype.loadPlugins = function () {
        
        var self = this;
        var promise = self.ionicManager.runCommand(Constants.CMD_PLUGIN_LIST);
    ...
    module.exports = IonicPluginsDialog;
});